{
 "cells": [
  {
   "cell_type": "markdown",
   "id": "1e39ebd9-f9c9-42f9-9c52-e58d24bccc67",
   "metadata": {},
   "source": [
  ...
  {
   "cell_type": "markdown",
   "id": "1df3e982-6d26-415b-be70-549b01a7a495",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 28,
   "id": "f806847b-07e4-4e96-af4e-1cf65f266e2f",
   "metadata": {},
   "outputs": [],
   "source": [
    "import pandas as pd\n",
  ...
  {
   "cell_type": "markdown",
   "id": "af368c95-162a-4820-bdb8-220a29dbe36b",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 29,
   "id": "6c673706-6d37-435e-bf2c-8d7b7afbfbf6",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  {
   "cell_type": "markdown",
   "id": "2743615a-e90e-4cf0-b28c-d836631316ff",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 30,
   "id": "8fd4fc8c-5bc9-4b29-acb1-d74400153b8e",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  {
   "cell_type": "markdown",
   "id": "433e6994-f879-4c8b-be82-4990b03a385c",
   "metadata": {},
   "source": [
  ...
  {
   "cell_type": "markdown",
   "id": "b1dc055b-291d-4dad-ac42-6a1d8eb4a4fa",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 31,
   "id": "78466bcf-f96c-4520-afc1-bd7959e7d3a7",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  {
   "cell_type": "markdown",
   "id": "b298dffe-c505-41da-8864-d769d589aabb",
   "metadata": {},
   "source": [
  ...
  {
   "cell_type": "markdown",
   "id": "387bf952-40a1-4c2e-b58b-7c2645e3f5dc",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 57,
   "id": "7f199c35-21c4-414f-9c05-c62b31b241ae",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  {
   "cell_type": "markdown",
   "id": "db891874-2f05-4c91-a6c3-10b5e1f6a12f",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 62,
   "id": "44101fd3-3164-4c97-a816-7b76fd1e9325",
   "metadata": {},
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "                  institution_name  PARTIC_MEN  PARTIC_WOMEN    REV_MEN  \\\n",
       "8709  Appalachian State University        18.0          23.0  1473653.0   \n",
       "8710  Appalachian State University        54.0         134.0   518857.0   \n",
       "8711  Appalachian State University         NaN          24.0        NaN   \n",
       "8712  Appalachian State University       134.0           NaN  8506239.0   \n",
       "8713  Appalachian State University        11.0           9.0   278858.0   \n",
       "...                            ...         ...           ...        ...   \n",
       "9196   Western Carolina University         8.0          10.0   266204.0   \n",
       "9197   Western Carolina University         NaN          29.0        NaN   \n",
       "9198   Western Carolina University         NaN          20.0        NaN   \n",
       "9199   Western Carolina University         NaN           9.0        NaN   \n",
       "9200   Western Carolina University         NaN          16.0        NaN   \n",
       "\n",
       "      REV_WOMEN              Sports  \n",
       "8709  1195867.0          Basketball  \n",
       "8710   769212.0  All Track Combined  \n",
       "8711   583458.0        Field Hockey  \n",
       "8712        NaN            Football  \n",
       "8713   236861.0                Golf  \n",
       "...         ...                 ...  \n",
       "9196   212692.0                Golf  \n",
       "9197   418345.0              Soccer  \n",
       "9198   373714.0            Softball  \n",
       "9199   208372.0              Tennis  \n",
       "9200   408956.0          Volleyball  \n",
       "\n",
  ...
  {
   "cell_type": "markdown",
   "id": "e9aeb81d-6a68-432c-af3f-a917fbc9c86c",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 63,
   "id": "8a26cb63-d7b2-4377-888a-217000c8c86b",
   "metadata": {},
   "outputs": [],
   "source": [
    "ncsports_subset = df[[\"institution_name\",\"PARTIC_MEN\",\"PARTIC_WOMEN\",\"REV_MEN\",\"REV_WOMEN\",\"Sports\"]][8709:9201].copy()"
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 60,
   "id": "7161bae6-ac76-441f-82b4-db150f4620f3",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  {
   "cell_type": "markdown",
   "id": "a9b87ba6-a069-4513-82b6-85d8edf41c03",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 56,
   "id": "0855fd00-d598-4242-b2d7-b77fa3a8975b",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  {
   "cell_type": "markdown",
   "id": "214b186b-7c43-4adc-90ec-8edd8361bfb9",
   "metadata": {},
   "source": [
    "## All done!\n",
    "\n",
  ...
  },
  {
   ...
   "id": "f2cf857d-6bc2-4d7c-997e-8430da1b7351",
   "metadata": {},
   "outputs": [],
   "source": []
  }
